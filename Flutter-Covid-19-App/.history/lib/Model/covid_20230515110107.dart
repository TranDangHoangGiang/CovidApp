class Autogenerated {
  ...
  Autogenerated({required this.total,required this.today,required this.overview,required this.locations});
  ...
  Autogenerated.fromJson(Map<String, dynamic> json) {
   ...
   Non-nullable instance field 'locations' must be initialized.
...
class Total {
  ...
  Total({ required this.internal,  required this.world});
...
class Internal {
  ...
  Internal({ required this.death, required this.treating, required this.cases, required this.recovered});
